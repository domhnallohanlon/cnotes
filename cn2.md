...
Unlike binary operators, unary operators only require one operand. They allow you to write your code more concisely. For example, `i++` or `i--` will incrememt or decrement the integer `i`. 
